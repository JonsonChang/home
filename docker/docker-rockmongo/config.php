...
*/
$MONGO["servers"][$i]["mongo_name"] = "arkflex1";//mongo server name
$MONGO["servers"][$i]["mongo_host"] = "172.16.20.90";//mongo host
...
$MONGO["servers"][$i]["mongo_name"] = "arkflex2";
$MONGO["servers"][$i]["mongo_host"] = "172.16.20.91";
$MONGO["servers"][$i]["mongo_port"] = "27017";
$MONGO["servers"][$i]["control_users"]["admin"] = "admin";
$i ++;

$MONGO["servers"][$i]["mongo_name"] = "arkflex3";
$MONGO["servers"][$i]["mongo_host"] = "172.16.20.92";
$MONGO["servers"][$i]["mongo_port"] = "27017";
$MONGO["servers"][$i]["control_users"]["admin"] = "admin";
$i ++;
$MONGO["servers"][$i]["mongo_name"] = "arkflex4";
$MONGO["servers"][$i]["mongo_host"] = "172.16.20.93";
$MONGO["servers"][$i]["mongo_port"] = "27017";
$MONGO["servers"][$i]["control_users"]["admin"] = "admin";
$i ++;
